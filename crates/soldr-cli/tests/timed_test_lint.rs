...
const LEGACY_ALLOWLIST: &[&str] = &[
    ...
    "crates/soldr-cli/src/binaries_tests.rs",
    "crates/soldr-cache/src/cache_lib/auto_gc.rs",
    "crates/soldr-cache/src/cache_lib/gc_tests.rs",
    ...
    "crates/soldr-cli/src/linker_tests.rs",
    ...
    "crates/soldr-core/src/self_relocate_tests.rs",
